...
This repository is also being used as a part of GitHub training, this repository also has some baked in merge conflicts for practice. to practice Git and GitHub.
